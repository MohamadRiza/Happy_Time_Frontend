...
// MOblile view filter close when click somewhere
  useEffect(() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={viewMode === "list" ? "flex-1" : "p-4"}>
                        ...
                        <p
                          className={`text-gray-400 text-xs mb-3 ${viewMode === "list" ? "line-clamp-2" : "line-clamp-2"}`}
                        >
                          {product.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-1 mb-3">
                          <span
                            className={`text-[10px] px-2 py-1 rounded ${getGenderBadgeClass(product.gender, product.productType)}`}
                          >
                            {getGenderDisplay(
                              product.gender,
                              product.productType,
                        ...
                        <div className="mt-auto">
                          <span className="text-gold hover:text-yellow-300 text-sm font-medium flex items-center gap-1 group-hover:gap-2 transition">View Details</span>
                        </div>
                      </div>
                    </Link>
                  );
