    ...
    <div className="bg-black/80 backdrop-blur-sm border-b border-gold/20 text-gold text-xs py-2.5 px-4 hidden sm:flex items-center overflow-hidden">
      ...
      <div className="flex items-center gap-6 whitespace-nowrap animate-marquee">
        <span className="flex items-center">
          ...
          <a 
            href="https://www.google.com/maps?q=Happy+Time+(Pvt)+Ltd,+Pettah,+Colombo" 
            target="_blank" 
        ...
        <span className="flex items-center">
          ...
          <a href="tel:+94771234567" className="hover:text-white transition-colors duration-200">+94 77 123 4567</a>
          <span className="mx-1">|</span>
          <a href="tel:+94712345678" className="hover:text-white transition-colors duration-200">+94 71 234 5678</a>
        </span>
